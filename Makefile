...
ifdef MYTOPLING_DIST_NAME
  DMYTOPLING_DIST_NAME := -DMYTOPLING_DIST_NAME="${MYTOPLING_DIST_NAME}" \
        -DCOMPILATION_COMMENT="${MYTOPLING_DIST_NAME} Enterprise" \
        -DCOMPILATION_COMMENT_SERVER="${MYTOPLING_DIST_NAME} Enterprise Server"
endif

ifdef MYTOPLING_SHOP_ADDR
  DMYTOPLING_DIST_NAME += -DMYTOPLING_SHOP_ADDR="${MYTOPLING_SHOP_ADDR}"
endif
